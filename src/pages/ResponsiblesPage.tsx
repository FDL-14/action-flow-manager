...
import { Plus, UserX, Users, UserRound } from 'lucide-react';
...
const ResponsiblesPage = () => {
  ...
  const [activeTab, setActiveTab] = useState<'all' | 'responsible' | 'requester'>('all');
    ...
    <div className="container mx-auto py-6 px-4">
      ...
      <div className="mb-6">
        <Tabs 
          defaultValue="all" 
          value={activeTab} 
          onValueChange={(value) => setActiveTab(value as 'all' | 'responsible' | 'requester')}
        >
        ...
        <h2 className="text-xl font-semibold mb-2">
          Lista de Responsáveis/Solicitantes
        </h2>
